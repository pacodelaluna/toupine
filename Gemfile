...
gem 'spree_product_assembly', github: 'pacodelaluna/spree-product-assembly', branch: '2-4-stable'
...
gem 'spree_cyber_plus_paiement', github: 'gdsn13/cyber_plus_paiement', branch: 'master'
